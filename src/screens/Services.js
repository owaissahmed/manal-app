        ...
        <SafeAreaView style={{ flex: 1 }}>
            <Background height={scale(320)} width={scale(420)} BackgroundImage={HalfCar} imageOpacity={0.1}>
                <View style={{ flex: 1, alignItems: 'center', justifyContent: "space-between", marginTop: scale(30) }}>
                    <TouchableOpacity style={{alignSelf: 'flex-end',}} onPress={() => navigation.navigate('Location')}>
                        <View
                            style={{
                                flexDirection: 'row', alignItems: 'center',  marginTop: scale(10), marginRight: scale(15),
                            }}>
                    ...
                    <View style={{ gap: scale(15), marginTop: scale(-100) }}>
                        <TouchableOpacity onPress={() => navigation.navigate('CarWash')}>
                            <View
                                style={{
                                    flexDirection: 'row', justifyContent: 'space-around', paddingHorizontal: scale(10), alignItems: 'center', width: scale(280), height: scale(125), borderColor: '#13418C', borderWidth: 1, borderRadius: scale(20), backgroundColor: 'white',
                                }}>
                        ...
                        <View
                            style={{ height: scale(125), width: scale(280), paddingHorizontal: scale(30), justifyContent: 'center', borderColor: '#13418C', borderWidth: 1, borderRadius: scale(20), backgroundColor: 'white', }}>
                            <View
