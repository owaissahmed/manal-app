            ...
            <Background height={scale(460)} width={scale(350)} BackgroundImage={CarWashBackground} imageOpacity={1}>
                <ScrollView>
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('CarVehicle')} style={{ alignItems: 'center', justifyContent: 'center', gap: scale(20), backgroundColor: "white", borderRadius: scale(20), height: scale(170), borderColor: 'black', borderWidth: scale(1), borderStyle: 'dashed', width: scale(280) }}>
                        ...
                        <View style={{ marginTop: scale(20),marginBottom:scale(5), alignItems: 'center', justifyContent: 'center', backgroundColor: "white", borderRadius: scale(20), height: scale(60), width: scale(280) }}>
                            <Image style={{ padding: scale(4) }} source={Dubai} />
                        </View>
                        <View>
                            <TextField fontSize={scale(16)} borderColor='white' style={{ width: scale(280), backgroundColor: 'white', margin: scale(4) }} placeholder='Plate Code' />
                            <TextField fontSize={scale(16)} borderColor='white' style={{ width: scale(280), backgroundColor: 'white', margin: scale(4) }} placeholder='Plate Number' />
                            <TextField fontSize={scale(16)} borderColor='white' style={{ width: scale(280), backgroundColor: 'white', margin: scale(4) }} placeholder='City' />
                        </View>
