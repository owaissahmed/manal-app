...
const Navigation = () => {
    ...
    return (
        <Stack.Navigator>
            ...
            <Stack.Screen name="CarSelection" component={CarSelection} options={{ headerShown: true, headerTransparent: true, headerTitleStyle: { color: "#770996" }, headerTitle: 'ADD A CAR' }} />
